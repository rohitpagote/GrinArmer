                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  initialValue: snapshot.data[1]["name"],
                              ...
                              Container(
                                padding: EdgeInsets.only(left: 20, right: 20),
                                child: TextFormField(
                                  initialValue: snapshot.data[1]["phone"],
                              ...
                              Container(
                                padding: EdgeInsets.only(left: 20, right: 20),
                                child: TextFormField(
                                  initialValue: snapshot.data[1]["gst"],
                                  style: TextStyle(
                                    fontSize: 16,
                                    height: 1.0,
                                  ),
                              ...
                              Container(
                                ...
                                child: DropdownSearch<String>(
                                  ...
                                  label: "Country",
                                  selectedItem: snapshot.data[1]['country'],
                                  autoValidateMode:
                                      AutovalidateMode.onUserInteraction,
                              ...
                              Container(
                                ...
                                child: DropdownSearch<String>(
                                  ...
                                  items: states,
                                  label: "State",
                                  selectedItem: snapshot.data[1]['state'],
                                  showSearchBox: true,
                                  autoValidateMode:
                                      AutovalidateMode.onUserInteraction,
                              ...
                              Container(
                                ...
                                child: DropdownSearch<String>(
                                  ...
                                  items: cities,
                                  label: "City",
                                  selectedItem: snapshot.data[1]['city'],
                                  showSearchBox: true,
                                  autoValidateMode:
                                      AutovalidateMode.onUserInteraction,
                              ...
                              Container(
                                padding: EdgeInsets.only(left: 20, right: 20),
                                child: TextFormField(
                                  initialValue: snapshot.data[1]['pincode'],
